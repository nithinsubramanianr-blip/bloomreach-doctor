 ...
 * assembles the initial pre-fix PRS (52 Amber) on the server, then hands off to
 * the client Dashboard for tab navigation (Scorecard / Ask the doctor) and the
 * Option X refresh. The Live PLP is its own route (/plp).
 */
