 ...
 * assembles the initial pre-fix PRS on the server (3 Red — the 3 live MCP dims;
 * BRUID & Rule Conflicts are out of scope — Discovery not enabled — excluded), then hands
 * off to the client Dashboard for tab navigation (Scorecard /
